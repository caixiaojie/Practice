package com.yanyu.practice.pickerview;
...
import com.yanyu.practice.pickerview.bean.CardBean;
import com.yanyu.practice.pickerview.bean.ProvinceBean;
...
public class PickerViewMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_picker_view);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_Time && pvTime != null) {
            ...
            startActivity(new Intent(PickerViewMainActivity.this, JsonDataActivity.class));
        } else if (v.getId() == R.id.btn_fragment) {//跳转到 fragment
            startActivity(new Intent(PickerViewMainActivity.this, FragmentTestActivity.class));
        } else if (v.getId() == R.id.btn_lunar) {
            pvCustomLunar.show();
        } else if (v.getId() == R.id.btn_circle) {
            startActivity(new Intent(PickerViewMainActivity.this, TestCircleWheelViewActivity.class));
        }
    }
    ...
    private void initLunarPicker() {
        ...
        pvCustomLunar = new TimePickerBuilder(this, new OnTimeSelectListener() {
            ...
            public void onTimeSelect(Date date, View v) {//选中事件回调
                Toast.makeText(PickerViewMainActivity.this, getTime(date), Toast.LENGTH_SHORT).show();
            }
        })
            ...
            public void onOptionsSelect(int options1, int options2, int options3, View v) {
                ...
                .setOptionsSelectChangeListener(new OnOptionsSelectChangeListener() {
                    ...
                    public void onOptionsSelectChanged(int options1, int options2, int options3) {
                        ...
                        Toast.makeText(PickerViewMainActivity.this, str, Toast.LENGTH_SHORT).show();
                    }
                })
                .build();
